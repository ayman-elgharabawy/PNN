...
def loadData(filename, featuresno, labelno,labelvalue, iteration,lrate,hn,recurrent):
    ...
    tot_error=trainingNoValidation(iteration, labelno, train_features,train_labels, featuresno, labelno,labelvalue,lrate,hn,20,recurrent)
...
train_error = loadData(filename='Data\\LRData\\iris.txt', featuresno=784,labelno=1,labelvalue=10,iteration=500,lrate=0.01,hn=50,recurrent=false) 
