# Use Python 3.7.3
#Convolution preference net based on spearma ranking
import numpy as np
...
def loadData(featuresno, labelno,labelvalue, iteration,lrate,hn,recurrent):
    ...
    train_labels=convertMultilabel(train_labels,labelno)
    # conv = Conv3x3(8)                  # 28x28x1 -> 26x26x8
    # pool = MaxPool2()                  # 26x26x8 -> 13x13x8
    # softmax = Softmax(13 * 13 * 8, 10) # 13x13x8 -> 10
    flatterd=[]
    ...
    tot_error=trainingNoValidation(iteration, labelno, train_features,train_labels, featuresno, labelno,labelvalue,lrate,hn,2,recurrent)
...
train_error = loadData( featuresno=784,labelno=10,labelvalue=2,iteration=500,lrate=0.07,hn=1500,recurrent=false) 
