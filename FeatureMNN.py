...
def back_propagation(net,row,expected,noofclassvalues,scale,dropout,cache,point):
     for i in reversed(range(len(net))):
            ...
            for j in range(len(layer)):
                ...
                neuron['delta']=errors[j]*dSSS(neuron['result'],2,10)
...
loadData(filename='C:\\Github\\PNN\\Data\\ClassificationData\\glass.csv',featuresno= 9,noofclassvalues=6,labelno=9,scale=5,epoches=50000,lr=0.3,dropout=false,point=3) 
