...
if __name__ == '__main__':
    ...
    save_path = 'C:\\Github\\PNN\\Numpy-CNN-master\\aa.pk'#args.save_path
    ...
    for i in t:
        ...
        t.set_description("Acc:%0.2f%%" % (float(corr/(i+1))))
        
    print("Overall Spearman Ranking Accuracy: %.2f" % (float(corr/len(test_data))))
    x = np.arange(10)
