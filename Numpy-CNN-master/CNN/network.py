...
def conv(image, label, params, conv_s, pool_f, pool_s):
    ...
    # dout=DSpearman(probs,label)
    dout = dSSS(probs,10,1)
    # dout=  np.array([np.array([x]) for x in dout])
...
def train(num_classes = 10, lr = 0.01, beta1 = 0.95, beta2 = 0.99, img_dim = 28, img_depth = 1, f = 5, num_filt1 = 8, num_filt2 = 8, batch_size = 32, num_epochs = 500, save_path = 'params.pkl'):
